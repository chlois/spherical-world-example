...
// modified based on https://github.com/SebLague/Sphere-Pathfinding
public class Pathfinder : MonoBehaviour {
    ...
    public List<Vector3> FindPath(Vector3 targetPos) {
        Node startNode = GetClosestNodeFromWorldPoint(targetPos);
        Node targetNode = GetClosestNodeFromWorldPoint(transform.position);
